...
def generate_release_notes(commits: list[str], version: str, repo_name: str, files_changed: list[str] = None) -> str:
...
Important: Base every claim strictly on the commit messages and file changes above. Do not invent features, behavior, or details not evidenced by this data. If a commit is vague (e.g. "fix", "update", "wip") and the file changes don't clarify intent, group it under "Other" or "Maintenance" rather than guessing what it does.
"""
